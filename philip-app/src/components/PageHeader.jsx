...
export default function PageHeader() {
  ...
  const handleLogout = () => {
    ...
    // 2. Gunakan window.location agar App.jsx mengecek ulang status login
        ...
        <div className="relative">
          ...
          {notifOpen && (
            <div className="absolute right-0 mt-2 w-72 bg-white rounded-2xl shadow-xl border border-red-100 p-4 z-50">
              <p className="font-bold text-red-900 mb-3 text-sm">
                Notifikasi
              </p>
              ...
              {[
                ...
                <div
                  key={i}
                  className="flex items-start gap-3 py-2 border-b border-red-50 last:border-0"
                >
        ...
        <div className="relative">
          ...
          {profileOpen && (
            <div className="absolute right-0 mt-2 w-48 bg-white rounded-2xl shadow-xl border border-red-100 overflow-hidden z-50">
              ...
              <button className="w-full text-left px-4 py-2.5 text-sm font-medium hover:bg-red-50 text-gray-700 hover:text-red-800 transition-colors">
                Profil Saya
              </button>
              ...
              <button
                ...
                className="w-full text-left px-4 py-2.5 text-sm font-medium hover:bg-red-50 text-red-700 hover:text-red-900 transition-colors"
              >
                Keluar
              </button>
